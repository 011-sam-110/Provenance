 ...
 * be checked cheaply.
 *
 * Measured 2026-09-23 with `npx vitest list` on origin/main at b0dd285, plus the one case
 * this branch (fix/rollup-store-fixture-date-rot) adds to an existing file.
 *
