 ...
 * be checked cheaply.
 *
 * Measured 2026-09-18 with `npx vitest list` on origin/main at ac4bf8d, plus this branch's
 * 2 new cases in an existing file (fix/signalcard-rank-by-declared-metric), so `files` is
 * unchanged and only `cases` moves.
 *
