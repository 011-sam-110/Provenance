 ...
 * be checked cheaply.
 *
 * Measured 2026-09-23 with `npx vitest list` on origin/main at b0dd285, plus the 7 cases
 * this branch (fix/signal-sourceAt-wiring) adds across 3 existing files.
 *
